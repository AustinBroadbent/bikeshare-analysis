...
**I verified that there was no loss of data when running the `split_csv()` function or during upload [(Kaggle Notebook)](https://www.kaggle.com/code/austinbroadbent/split-csvs). The resulting table contained 5,783,100 observations and 13 columns:**
...
knitr::include_graphics("C:/Users/Administrator/Downloads/long-histogram.png")
```
...
knitr::include_graphics("C:/Users/Administrator/Downloads/short-histogram.png")
```
