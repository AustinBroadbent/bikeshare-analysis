...
missing_df <- read_csv("data/CSVs/missing_values.csv", show_col_types = FALSE)
...
duplicates_df <- read_csv("data/CSVs/duplicate_rows.csv", show_col_types = FALSE)
...
example_duplicate <- read_csv("data/CSVs/example_duplicate.csv", show_col_types = FALSE)
